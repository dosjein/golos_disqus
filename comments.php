...
wp_register_script( 'golosmin_embed_script', plugins_url( '/media/js/golos.min.js', __FILE__ ) );
wp_localize_script( 'golosmin_embed_script', 'embedVars', $embed_vars );
wp_enqueue_script(  'golosmin_embed_script', plugins_url( '/media/js/golos.min.js', __FILE__ ) );


wp_register_script( 'golos_embed_script', plugins_url( '/media/js/golos.js', __FILE__ ) );
wp_localize_script( 'golos_embed_script', 'embedVars', $embed_vars );
wp_enqueue_script( 'golos_embed_script', plugins_url( '/media/js/golos.js', __FILE__ ) );
